          ...
          <div className="container mx-auto flex px-5 py-9 items-center justify-center flex-col">
            ...
            <div className="text-center lg:w-2/3 w-full">
              <p className="leading-relaxed mb-8">
                ...
                understanding. As the only global social network built on a
                Question format, we are a bit different from other services you
                might use. How you engage with friends and express yourself on
                SLVL is done through the lens of what your social connections
                are curious to learn about you. Through the natural curiosity of
                questions, SLVL to be a safe, fun and engaging place for
                learning more about yourself and exploring the social world
                around you.
              </p>
